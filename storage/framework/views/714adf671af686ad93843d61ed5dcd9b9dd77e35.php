      ...
      <div class="x_content">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td><?php echo e($operator->second_name); ?></td>
            <td><?php echo e($operator->phone); ?></td>
            <td><?php echo e($operator->address); ?></td>
            <td><?php echo e($operator->created_at); ?></td>
            <td><?php echo e($operator->updated_at); ?></td>
            <td>
              <div class="text-center dropdown" id="user-header">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="<?php echo e(route('sysfile.operators.edit', $operator->id)); ?>"><i class="glyphicon glyphicon-edit"></i><span>Editar</span></a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('sysfile.operators.destroy', $operator->id)); ?>"><i  class="glyphicon glyphicon-remove"></i><span>Borrar</span></a>
                    </li>
                  </ul>
              </div>
            </td>
