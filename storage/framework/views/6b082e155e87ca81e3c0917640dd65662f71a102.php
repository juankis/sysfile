<?php $__env->startSection('titlePage', 'Direcciones - Clientes'); ?>
      ...
      <div class="x_content">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td><?php echo e($address->location); ?></td>
            <td><?php echo e($address->customer->name); ?> [<?php echo e($address->customer->id); ?>]</td>
            <td><?php echo e($address->created_at); ?></td>
            <td><?php echo e($address->updated_at); ?></td>
            <td>
              <div class="text-center dropdown" id="user-header">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="<?php echo e(route('sysfile.addresses.edit', $address->id)); ?>"><i class="glyphicon glyphicon-edit"></i><span>Editar</span></a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('sysfile.addresses.destroy', $address->id)); ?>"><i  class="glyphicon glyphicon-remove"></i><span>Borrar</span></a>
                    </li>
                  </ul>
              </div>
            </td>
