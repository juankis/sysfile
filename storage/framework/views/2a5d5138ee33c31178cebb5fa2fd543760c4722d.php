<?php $__env->startSection('titlePage', 'Referentes'); ?>
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tr>
            <td><?php echo e($referent->id); ?></td>
            <td><?php echo e($referent->name); ?></td>
            <td><?php echo e($referent->phone); ?></td>
            <td><?php echo e($referent->ci); ?></td>
            <td><?php echo e($referent->email); ?></td>
            <td><?php echo e($referent->autorization); ?></td>
            <td><?php echo e($referent->department->name); ?> [<?php echo e($referent->department->id); ?>]</td>
            <td><?php echo e($referent->updated_at); ?></td>
            <td><div class="text-center dropdown" id="user-header">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="<?php echo e(route('sysfile.referents.edit', $referent->id)); ?>"><i class="glyphicon glyphicon-edit"></i><span>Editar</span></a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('sysfile.referents.destroy', $referent->id)); ?>"><i  class="glyphicon glyphicon-remove"></i><span>Borrar</span></a>
                    </li>
                  </ul>
              </div></td>
          </tr>
