<?php $__env->startSection('titlePage', 'Departamentos - Clintes'); ?>
      ...
      <div class="x_content">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td><?php echo e($department->customer->name); ?> [<?php echo e($department->customer->id); ?>]</td>
            ...
            <td>
              <div class="text-center dropdown" id="user-header">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="<?php echo e(route('sysfile.departments.edit', $department->id)); ?>"><i class="glyphicon glyphicon-edit"></i><span>Editar</span></a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('sysfile.departments.destroy', $department->id)); ?>"><i  class="glyphicon glyphicon-remove"></i><span>Borrar</span></a>
                    </li>
                  </ul>
              </div>
            </td>
